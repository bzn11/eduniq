...
export default function HomePageContent() {
  ...
  const termName = activeTerm?.name ?? (hasTerms ? "—" : "No terms yet");
    ...
    <div className="flex flex-col gap-8 sm:gap-10">
      <header className="flex flex-col gap-1">
        ...
        <p className="text-sm text-zinc-500">
          {hasTerms ? "Current term overview" : "Create a term to start tracking courses"}
        </p>
      </header>
      ...
      {!hasTerms && (
        <section
          ...
          className="rounded-xl border border-dashed border-zinc-300 bg-zinc-50/50 px-5 py-10 text-center sm:px-8"
        >
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <button
              ...
              className="rounded-lg border border-zinc-900 bg-zinc-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-zinc-800"
            >
              Add term
            </button>
            <Link
              href="/history"
              className="rounded-lg border border-zinc-200 bg-white px-4 py-2.5 text-sm font-medium text-zinc-900 hover:bg-zinc-50"
            >
              Manage terms
            </Link>
          </div>
